...
HideTabsPage::HideTabsPage() : AppletFrame(true, true) {
    ...
    ams = new brls::ToggleListItem("menus/main/update_ams_tab"_i18n, util::getBoolValue(hideStatus, "atmosphere"));
    list->addView(ams);

    atmosphereentries = new brls::ToggleListItem("menus/ams_update/update_atm_and_deepsea"_i18n, util::getBoolValue(hideStatus, "atmosphereentries"));
    ...
    hidetabs = new brls::ToggleListItem("menus/tools/hide_tabs"_i18n, util::getBoolValue(hideStatus, "hidetabs"));
    list->addView(hidetabs);
    ...
    list->registerAction("menus/cheats/exclude_titles_save"_i18n, brls::Key::B, [this] { 
        ...
        updatedStatus["hidetabs"] = hidetabs->getToggleState();
